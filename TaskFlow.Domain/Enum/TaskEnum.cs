...
namespace TaskFlow.Domain.Enum
{
    public class TaskEnum
    {
        ...
        public enum TaskStatu // •	An enum (short for "enumeration") is a named list of related constant values. 2. Use it when a variable should only hold one value from a fixed set (e.g., priority levels or status).Enums make code clearer and less error - prone than using raw numbers or strings.
        {
